...
const UECodeGen_Private::FArrayPropertyParams Z_Construct_UDelegateFunction_DialogueTool_DialogueResponsesUpdated__DelegateSignature_Statics::NewProp_Responses = { "Responses", nullptr, (EPropertyFlags)0x0010008008000182, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(_Script_DialogueTool_eventDialogueResponsesUpdated_Parms, Responses), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_Responses_MetaData), NewProp_Responses_MetaData) }; // 2533444084
...
void FDialogueFinished_DelegateWrapper(const FMulticastScriptDelegate& DialogueFinished)
{
	DialogueFinished.ProcessMulticastDelegate<UObject>(NULL);
}
...
DEFINE_FUNCTION(UDialogueManager::execStartDialogue)
{
	...
	P_FINISH;
	P_NATIVE_BEGIN;
	*(bool*)Z_Param__Result=P_THIS->StartDialogue(Z_Param_dialogue,Z_Param_context);
	P_NATIVE_END;
}
...
struct Z_Construct_UClass_UDialogueManager_Statics
{
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_UDialogueManager_StartDialogue, "StartDialogue" }, // 994031682
	};
...
const UECodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_UDialogueManager_Statics::NewProp_OnDialogueFinished = { "OnDialogueFinished", nullptr, (EPropertyFlags)0x0010000010080000, UECodeGen_Private::EPropertyGenFlags::InlineMulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDialogueManager, OnDialogueFinished), Z_Construct_UDelegateFunction_DialogueTool_DialogueFinished__DelegateSignature, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_OnDialogueFinished_MetaData), NewProp_OnDialogueFinished_MetaData) }; // 4139299171
...
struct Z_CompiledInDeferFile_FID_Projects_project_alay_Plugins_DialogueTool_Source_DialogueTool_Public_DialogueManager_h__Script_DialogueTool_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UDialogueManager, UDialogueManager::StaticClass, TEXT("UDialogueManager"), &Z_Registration_Info_UClass_UDialogueManager, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UDialogueManager), 2926655697U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Projects_project_alay_Plugins_DialogueTool_Source_DialogueTool_Public_DialogueManager_h__Script_DialogueTool_4286892673(TEXT("/Script/DialogueTool"),
