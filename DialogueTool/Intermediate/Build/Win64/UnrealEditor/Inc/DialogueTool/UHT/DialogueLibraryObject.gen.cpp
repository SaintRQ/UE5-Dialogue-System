...
struct Z_CompiledInDeferFile_FID_Projects_project_alay_Plugins_DialogueTool_Source_DialogueTool_Public_DialogueLibraryObject_h__Script_DialogueTool_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UDialogueLibraryObject, UDialogueLibraryObject::StaticClass, TEXT("UDialogueLibraryObject"), &Z_Registration_Info_UClass_UDialogueLibraryObject, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UDialogueLibraryObject), 3180259112U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Projects_project_alay_Plugins_DialogueTool_Source_DialogueTool_Public_DialogueLibraryObject_h__Script_DialogueTool_3484373235(TEXT("/Script/DialogueTool"),
